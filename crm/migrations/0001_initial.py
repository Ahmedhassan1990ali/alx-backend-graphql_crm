# Generated by Django 5.1.6 on 2025-08-17 04:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=20, validators=[django.core.validators.RegexValidator(message="Phone number must be in format: '+1234567890' or '123-456-7890'", regex='^\\+?\\d{3}[-.\\s]?\\d{3}[-.\\s]?\\d{4}$')])),
            ],
        ),
        migrations.CreateModel(
            name='Product',
